...
import { House, FolderOpen, Search, Settings, Library, Brain } from 'lucide-react-native';
  ...
  return (
    ...
    >
      <Tabs.Screen
        ...
        options={{
          title: 'Home',
          tabBarIcon: ({ size, color }) => <House size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="review"
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Library',
          tabBarIcon: ({ size, color }) => <Library size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="collections"
